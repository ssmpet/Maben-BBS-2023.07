...
<body>
	...
	<div class="container" style="margin-top: 80px;">
    	<div class="row">
	    	...
	    	<hr>
	    	<div class="col-sm-6">
			<form action="/bbs/city/cityinsert" method="post">
				<table class="table table-borderless mt-2 text-center" style="margin-bottom: 50px;">
	            	<tr>
                        ...
                        <td style="width:80%"><input type="text" name="cname" class="form-control" autofocus></label></td>
                    </tr>
                    <tr>
                        <td style="width:20%"><label class="col-form-label">CountryCode</label></td>
                        <td style="width:80%"><input type="text" name="countryCode" class="form-control"></label></td>
                    </tr>
                    <tr>
                        <td style="width:20%"><label class="col-form-label">시/군구 단위</label></td>
                        <td style="width:80%"><input type="text" name="district" class="form-control"></label></td>
                    </tr>
                    <tr>
                        <td style="width:20%"><label class="col-form-label">인구수</label></td>
                        <td style="width:80%"><input type="text" name="population" class="form-control"></label></td>
                    </tr>
                    <tr>
